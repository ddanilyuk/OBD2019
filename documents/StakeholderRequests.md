...
Більше: https://github.com/ddanilyuk/OBD2019/blob/master/documents/ProjectOne.md
...
https://uk.wikipedia.org/wiki/Бізнес-процес
...
https://library.if.ua/book/28/1898.html

### 1.3.3. Бізнес-проекти
...
Читання, вивчення біснез-плану, дослідження ринку, план маркетингу, оцінка можливостей фірми щодо інвестицій, термінів початку виробництва, обсягів виробництва, фінансовий план, охорона середовища.
 ...
 https://uk.wikipedia.org/wiki/Бізнес-план

### 1.3.4. Роль учасника бізнес проекту
...
https://socialimpactaward.com.ua/2018/05/21/команда-проекту-ролі-і-компетенції 


### 1.3.5. Форми бізнес-процесів
...
2. Веб-клієнт для користувачів, що передбачає моніторинг та управління відповідною інформацією.

Система управління проектами є відображенням інформації, що сформована на основі аналізу відповідних даних про проекти, з можливістю її перегляду, та подальшого редагування. Також являється платформою, що забезпечує комунікацію між учасниками проекту. Взаємодія з системою відбувається за допомогою графічного інтерфейсу на стороні клієнта.
