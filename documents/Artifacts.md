...
У каналу збуту є п'ять етапів просування товару до споживача:

1) Інформаційний: як ми підвищуємо обізнаність споживача про товари і послуги нашої компанії?

2) Оцінюючий: як ми допомагаємо клієнтам оцінювати ціннісні пропозиції нашої компанії?
...
**П'ятий блок** - фінансова стійкість. Блок включає матеріальний прибуток, який компанія отримує від кожного споживчого сегменту або від партнерів.
...
4) Оренда / рента / лізинг: цей потік створюється шляхом передачі клієнту тимчасових прав на користування певним активом протягом певного періоду часу за фіксовану плату;

5) Ліцензії: в цьому випадку потік доходу створюється за рахунок передачі прав на користування захищеної інтелектуальної власності;
...
1. Стратегічне співробітництво між неконкуруючими організаціями;

2. Співконкуренція: стратегічне партнерство між конкурентами;
...
Мінімізувати витрати слід в будь-якій бізнес-моделі, однак для деяких моделей зниження витрат має більше значення, ніж для інших.
