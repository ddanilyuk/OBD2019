...
[https://ru.wikipedia.org/wiki/Проектирование_программного_обеспечения]
...
[https://studopedia.su/8_55067_proektuvannya-programnogo-zabezpechennya.html]
...
[https://studopedia.info/1-113575.html]
...
Модель предметної області накладає обмеження на бізнес-логіку і структури даних.Визначенню внутрішніх властивостей системи і деталізації її зовнішніх властивостей власне і присвячено проектування.
